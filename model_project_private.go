...
func NewProjectPrivate(role string, storage string, url string, publishedDate NullableString, id int64, title string, createdDate string, modifiedDate string) *ProjectPrivate {
	this := ProjectPrivate{}
	this.Url = url
...
func (o *ProjectPrivate) GetPublishedDate() string {
...
func (o *ProjectPrivate) GetPublishedDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProjectPrivate) SetPublishedDate(v string) {

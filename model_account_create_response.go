...
type _AccountCreateResponse AccountCreateResponse

// NewAccountCreateResponse instantiates a new AccountCreateResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAccountCreateResponse(accountId int64) *AccountCreateResponse {
...
func (o *AccountCreateResponse) GetAccountId() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
func (o *AccountCreateResponse) GetAccountIdOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AccountCreateResponse) SetAccountId(v int64) {
	o.AccountId = v
}
...
func (o *AccountCreateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountCreateResponse := _AccountCreateResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountCreateResponse)

	if err != nil {
		return err
	}

	*o = AccountCreateResponse(varAccountCreateResponse)

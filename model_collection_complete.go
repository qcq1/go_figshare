...
// checks if the CollectionComplete type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectionComplete{}

// CollectionComplete struct for CollectionComplete
type CollectionComplete struct {
	...
	RelatedMaterials []RelatedMaterial `json:"related_materials"`
...
type _CollectionComplete CollectionComplete
...
// GetRelatedMaterials returns the RelatedMaterials field value
...
// GetRelatedMaterialsOk returns a tuple with the RelatedMaterials field value
// and a boolean to check if the value has been set.
...
// SetRelatedMaterials sets field value
...
func (o CollectionComplete) MarshalJSON() ([]byte, error) {
...
func (o CollectionComplete) ToMap() (map[string]interface{}, error) {
...
func (o *CollectionComplete) UnmarshalJSON(data []byte) (err error) {
	...
	varCollectionComplete := _CollectionComplete{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCollectionComplete)

	if err != nil {
		return err
	}

	*o = CollectionComplete(varCollectionComplete)

	return err
}

type NullableCollectionComplete struct {
	value *CollectionComplete
	isSet bool
}

func (v NullableCollectionComplete) Get() *CollectionComplete {
	return v.value
}

func (v *NullableCollectionComplete) Set(val *CollectionComplete) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionComplete) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionComplete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionComplete(val *CollectionComplete) *NullableCollectionComplete {
	return &NullableCollectionComplete{value: val, isSet: true}
}

func (v NullableCollectionComplete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionComplete) UnmarshalJSON(src []byte) error {
	v.isSet = true

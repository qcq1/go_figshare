...
------------ | ------------- | ------------- | -------------
**Doi** | **string** | Only return collections with this doi | [optional] [default to null]
**Handle** | **string** | Only return collections with this handle | [optional] [default to null]
**Order** | **string** | The field by which to order. | [optional] [default to null]
**ResourceDoi** | **string** | Only return collections with this resource_doi | [optional] [default to null]
...
**ResourceId** | **string** | only return collections with this resource_id | [optional] [default to null]

...
------------ | ------------- | ------------- | -------------
**Authors** | [**[]Author**](Author.md) | List of article authors | [optional] [default to null]
...
**Files** | [**[]PublicFile**](PublicFile.md) | List of article files | [optional] [default to null]
**FolderStructure** | [***interface{}**](interface{}.md) | Mapping of file ids to folder paths, if folders are used | [optional] [default to null]

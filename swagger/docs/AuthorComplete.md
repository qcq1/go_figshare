...
`func NewAuthorComplete(firstName string, groupId int64, institutionId int64, isPublic int64, jobTitle string, lastName string, fullName string, id int64, isActive bool, orcidId string, urlName string, ) *AuthorComplete`

...
**ReviewDate** | **NullableString** | The last time a comment has been added to the review. | 
...
`func (o *CurationDetail) SetReviewDateNil(b bool)`

 SetReviewDateNil sets the value for ReviewDate to be an explicit nil

### UnsetReviewDate
`func (o *CurationDetail) UnsetReviewDate()`

UnsetReviewDate ensures that no value is present for ReviewDate, not even an explicit nil
### GetRequestNumber

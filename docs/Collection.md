...
`func NewCollection(id int64, title string, doi string, handle string, url string, timeline Timeline, publishedDate NullableString, ) *Collection`
...
`func (o *Collection) GetPublishedDate() string`

GetPublishedDate returns the PublishedDate field if non-nil, zero value otherwise.

### GetPublishedDateOk

`func (o *Collection) GetPublishedDateOk() (*string, bool)`
...
`func (o *Collection) SetPublishedDate(v string)`
...
`func (o *Collection) SetPublishedDateNil(b bool)`

 SetPublishedDateNil sets the value for PublishedDate to be an explicit nil

### UnsetPublishedDate
`func (o *Collection) UnsetPublishedDate()`

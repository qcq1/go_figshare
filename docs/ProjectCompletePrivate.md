...
`func (o *ProjectCompletePrivate) SetFigshareUrlNil(b bool)`

 SetFigshareUrlNil sets the value for FigshareUrl to be an explicit nil

### UnsetFigshareUrl
`func (o *ProjectCompletePrivate) UnsetFigshareUrl()`
...
`func (o *ProjectCompletePrivate) SetPublishedDateNil(b bool)`

 SetPublishedDateNil sets the value for PublishedDate to be an explicit nil

### UnsetPublishedDate
`func (o *ProjectCompletePrivate) UnsetPublishedDate()`
